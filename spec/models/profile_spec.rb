...
RSpec.describe Profile, type: :model do
  describe '#full_name' do
    it 'should combine the names without adding errant spaces' do
      ...
      expected_name = %w[Pascal Fluffy].compact.join([160].pack('U*'))
  ...
  describe '#valid?' do
    it 'should ve in a valid state' do
      ...
      expect(profile).to validate_presence_of(:family_name)
      expect(profile).to validate_presence_of(:given_name)
    end
  end
end
